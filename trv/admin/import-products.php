		...
		<div class="box">
			...
			<div class="fade" id="step1">
				...
				<div class="columns">
					<div class="column is-two-fifths">
						<a class="button is-fullwidth backgroundDark" href="/trv/media/plantilla-carga-productos-masiva.xlsx" download><i class="fas fa-file-excel"></i> Download template</a>
			...
			<div class="fade" id="step2" style="display: none">
				...
				<div class="has-text-centered">
					<button class="button backgroundDark" onclick="addProducts()"><i class="fas fa-circle-check"></i> Import information</button>
