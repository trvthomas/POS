...
<body>
	...
	<div class="contentBox loginBox">
		<div class="box">
			...
			<p class="has-text-centered">Log in with a user with <b>administrator permissions</b> to access the administrative dashboard for up to 1 hour</p>
			<hr>
			...
			$.ajax({
				...
				success: function(response) {
					if (response['errores'] == true) {
						...
						newNotification('Invalid credentials or you do not have administrator permissions', 'error');
