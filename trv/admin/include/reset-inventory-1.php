	...
	if (!$credentialsIncorrect) {
		...
		if ($result3->num_rows > 0) {
			...
			try {
				...
				// Content
				$mail->isHTML(true);
				$mail->Subject = 'Security Code - ' . $securityCode;
				$mail->Body = '<html>
				<head>
				<meta charset= "UTF-8">
				...
				<h1 style= "margin-bottom: 2px;">Security Code</h1>
				<p style= "margin-top: 2px;">You have received a request to perform one of the following actions:
				<br>- Reset your product inventory
				<br>- Delete a backup
				<br>To proceed with the request, enter the <b>following code</b> in your POS system.</p>
