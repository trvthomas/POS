...
$averageSales = 0;
$chartTable = "";
$bestSellerProducts = "<p class='has-text-centered is-size-5'><b>No results found</b></p>";
...
if (isset($_POST["getInfoToken"]) && $_POST["getInfoToken"] == "pos4862") {
	...
	if ($result->num_rows > 0) {
		...
		if ($result2->num_rows > 0) {
			...
			$numberSales .= '<p class= "is-size-7 has-text-weight-normal ' . $colorNumber . '">' . $calcPercentageNumber . '% compared to the <b>previous month</b></p>';
			$totalSales .= '<p class= "is-size-7 has-text-weight-normal ' . $colorTotal . '">' . $calcPercentageTotal . '% compared to the <b>previous month</b></p>';
		}
		...
		<div class= "column">
			<div class= "block">
			<h4 class= "is-size-6 has-text-grey">Units sold</h4>
