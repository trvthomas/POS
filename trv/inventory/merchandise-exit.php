...
<head>
	<title>Register Remove Stock Document</title>
...
<body onbeforeunload="return confirmationExit()">
	...
	<div class="contentBox">
		<h3 class="is-size-5">Remove Stock Document</h3>
		<p>Register the removal of items and products</p>
						...
						<div class="control has-icons-left">
							<span class="select is-fullwidth">
								<select id="selectType">
									<option value="Loss or damage">Loss or damage</option>
									<option value="Merchandise transfer">Merchandise transfer</option>
									<option value="Expired perishables">Expired perishables</option>
		...
		<div class="box">
			...
			<div class="columns">
				...
				<div class="column">
					<div class="block has-text-left">
						...
						<h4 class="is-size-6 has-text-grey">Products to be removed</h4>
			...
			<div class="has-text-centered">
				...
				<br><a class="button is-danger is-inverted is-small" href="/trv/inventory/merchandise-exit.php"><i class="fas fa-circle-xmark"></i> Cancel and restart</a>
			</div>
		</div>
	</div>
	...
	<script>
		...
		function registrarMovimiento() {
			...
			if (productsArray.length <= 0) {
				newNotification('Select the products to be removed', 'error');
				...
				var c = confirm("Please confirm this action. You are going to register an exit of " + thousands_separators(numberProducts) + " products.");
