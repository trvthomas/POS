...
<head>
	<title>Details receipt <?php echo $saleNumber; ?></title>
...
<body>
	...
	<?php if ($authorizeEnter == true) { ?>
		<div class="contentBox loginBox has-text-centered" style="margin-top: 10px;">
			<?php if ($source == "quickview") { ?>
				<a class="button is-small is-pulled-right" style="border: none;" href="/trv/invoice-details.php?id=<?php echo $_GET["id"]; ?>&source=web" target="_blank" title="Open in new tab"><span class="icon is-small"><i class="fas fa-up-right-from-square"></i></span></a>
			<?php } else { ?>
			...
			<div class="box">
				<h3 class="is-size-5">Details receipt <?php echo $saleNumber; ?></h3>
				<p><span class="tag is-rounded"><b><?php echo $numberProds; ?> product<?php echo $numberProdsSingPlu; ?></b></span> <?php if ($cancelled == 1) { ?> <span class="tag is-rounded is-danger is-light">Canceled sale</span> <?php } ?></p>
