...
if (isset($_POST["customerBusiness"]) && isset($_POST["customerDesign"]) && isset($_POST["customerEmail"]) && connection_status() == 0) {
	...
	try {
		...
		// Content
		$mail->isHTML(true);
		$mail->Subject = 'Your purchase in ' . $_POST["customerBusiness"];
		$mail->Body = '<html>
		<head>
		<meta charset= "UTF-8">
		<meta name= "viewport" content= "width=device-width, initial-scale=1">
		<title>Your purchase in ' . $_POST["customerBusiness"] . '</title>
		<style>
		.prodListPrice{
		float: right;
		padding-right: 15px;
		...
		<hr>
		<p style= "text-align: center;">This email has been automatically generated by <a href= "https://www.trvsolutions.com" target= "_blank">TRV Solutions</a>, if you have any questions or concerns about your purchase, charge, etc., please contact <b>' . $_POST["customerBusiness"] . '</b> directly.</p>
		</div>
		</body>
		</html>';
