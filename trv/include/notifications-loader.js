...
function newNotificationError() { newNotification('There was an error', 'error'); }
...
document.getElementById('overlayLoader').innerHTML = '<div class= "loaderBox"><div class= "imgProcessing"><img src= "/trv/media/loader.gif" alt= "Loading..." width= "100%" loading= "lazy"></div><h3 style= "margin-top: 2px;">Loading...</h3></div>';
